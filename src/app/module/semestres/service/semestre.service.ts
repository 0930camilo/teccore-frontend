...
export class SemestreService {
  ...
  listar(filtros: PaginacionRequest): Observable<ApiResponse<PaginacionRespuesta<Semestre>>> {
    return this.api.listar<Semestre>(this.url, filtros);
  }

  crear(payload: Record<string, unknown>): Observable<ApiResponse<Semestre>> {
    return this.api.crear<Semestre>(this.url, payload);
  }
}
