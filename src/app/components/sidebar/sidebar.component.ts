...
const MENU_ITEMS: MenuItem[] = [
  ...
  { label: 'Docentes', route: '/docentes', roles: [Rol.ADMIN_INSTITUCION, Rol.ADMIN_SEDE] },
  { label: 'Alumnos', route: '/alumnos', roles: [Rol.ADMIN_SEDE, Rol.DOCENTE] },
  { label: 'Materias', route: '/materias', roles: [Rol.ADMIN_INSTITUCION, Rol.ADMIN_SEDE, Rol.DOCENTE] },
