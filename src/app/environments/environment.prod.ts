export const environment = {
  ...
  activitiesApi: 'https://teccore-backend.onrender.com/actividades',
  paymentsApi: 'https://teccore-backend.onrender.com/pagos',
  reportsApi: 'https://teccore-backend.onrender.com/reportes',
};
