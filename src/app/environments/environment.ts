export const environment = {
  // Development environment flags (should be false for dev)
  production: false,
  ...
  activitiesApi: 'http://localhost:8080/actividades',
  paymentsApi: 'http://localhost:8080/pagos',
  reportsApi: 'http://localhost:8080/reportes',
};
