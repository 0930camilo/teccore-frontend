  ...
  },
  {
	...
	children: [
	  ...
	  },
	  {
		...
		data: { roles: [Rol.ADMIN_INSTITUCION, Rol.DOCENTE, Rol.ESTUDIANTE, Rol.AUXILIAR_CONTABLE] }
	  },
	  {
	  ...
	  },
	  {
		...
		canActivate: [roleGuard],
		data: { roles: [Rol.ADMIN_INSTITUCION] }
	  },
	  {
		path: 'semestres',
	  ...
	  },
	  {
		...
		canActivate: [roleGuard],
		data: { roles: [Rol.ADMIN_INSTITUCION, Rol.DOCENTE] }
	  },
	  {
		path: 'materias',
	  ...
	  },
	  {
		...
		canActivate: [roleGuard],
		data: { roles: [Rol.ADMIN_INSTITUCION, Rol.DOCENTE, Rol.ESTUDIANTE] }
	  },
	  {
		path: 'actividades',
	  ...
	  },
	  {
		...
		canActivate: [roleGuard],
		data: { roles: [Rol.ADMIN_INSTITUCION, Rol.AUXILIAR_CONTABLE] }
	  },
	  {
		path: 'reportes',
		loadComponent: () => import('./module/reportes/page/dashboard-page.component').then((m) => m.DashboardPageComponent),
